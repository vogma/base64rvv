...
size_t base64_decode_rvv_m2_naive(const char *data, int8_t *output, size_t input_length)
{
    ...
    const vuint8m2_t index_vector = __riscv_vle8_v_u8m2(index_decode, vlmax_8);
    ...
    for (; input_length >= vlmax_8; input_length -= vlmax_8)
    {
        ...
        const vint8m2_t vec_shift_lut = __riscv_vle8_v_i8m2(shift_lut, 16);
        ...
        vuint8m2_t result = __riscv_vrgather_vv_u8m2(packed_data_e8m2, index_vector, vlmax_8);
